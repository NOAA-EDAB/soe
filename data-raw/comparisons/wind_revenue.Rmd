---
title: "Fisheries Revenue from WEAs"
...
# Replace 'wind_revenue' with intended dataset
dataset<-ecodata::wind_revenue
dataset24<-ecodata24::wind_revenue

# Define dataset-specific arguments for plot functions
report<-list("MidAtlantic","NewEngland")
variable<-list("landing", "value")
plottype<-list("facets", "nofacets")
#epu<-list()
```
...
ecodata::plot_wind_revenue(report = report[1],varName = variable[1],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_wind_revenue(report = report[1],varName = variable[1],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[1],variable[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_wind_revenue(report = report[1],varName = variable[2],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_wind_revenue(report = report[1],varName = variable[2],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],variable[1])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_wind_revenue(report = report[2],varName = variable[1],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_wind_revenue(report = report[2],varName = variable[1],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],variable[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_wind_revenue(report = report[2],varName = variable[2],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_wind_revenue(report = report[2],varName = variable[2],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
