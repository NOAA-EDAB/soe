...
# Replace 'seabird_ne' with intended dataset
dataset<-ecodata::seabird_ne
dataset24<-ecodata24::seabird_ne

# Define dataset-specific arguments for plot functions
report<-list("MidAtlantic","NewEngland")
variable<-list("diversity", "productivity", "prey")
...
ecodata::plot_seabird_ne(report = report[2], varName = variable[1], n = 10)

ecodata24::plot_seabird_ne(report = report[2], varName = variable[1])
```

## `r paste(report[2], variable[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_seabird_ne(report = report[2], varName = variable[2], n = 10)

ecodata24::plot_seabird_ne(report = report[2], varName = variable[2])
```

## `r paste(report[2], variable[3])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_seabird_ne(report = report[2], varName = variable[3], n = 10)

ecodata24::plot_seabird_ne(report = report[2], varName = variable[3])
```
