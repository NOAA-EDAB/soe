---
title: "Chesapeake Bay Temperature"
...
# Replace 'ch_bay_temp' with intended dataset
dataset<-ecodata::ch_bay_temp
dataset24<-ecodata24::ch_bay_temp
...
ecodata::plot_ch_bay_temp(report = report[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_ch_bay_temp(report = report[1]) + 
