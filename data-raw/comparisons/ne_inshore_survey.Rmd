...
# Replace 'ne_inshore_survey' with intended dataset
dataset<-ecodata::ne_inshore_survey
dataset24<-ecodata24::ne_inshore_survey
...
ecodata::plot_ne_inshore_survey(report = report[2], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_ne_inshore_survey(report = report[2]) + 
