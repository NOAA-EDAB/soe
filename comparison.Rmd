...
```{r echo=FALSE}
if(as.Date(file.mtime("data/sav.rda")) < "2024-06-01") {print("NOT UPDATED")} else {print("UPDATED")}
```
...
```{r echo=FALSE}
cat("Variation in year",finalyear,":", round(((prevvaluecurrent-finalvalue24)/finalvalue24*100),2),"% (Tidal Fresh)")
```
...
```{r echo=FALSE}
cat("Variation in year",finalyear,":", round(((prevvaluecurrent-finalvalue24)/finalvalue24*100),2),"% (High Salinity)")
```
...
```{r echo=FALSE}
cat("Change from",finalyear24,":", round(((finalvaluecurrent-finalvalue24)/finalvalue24*100),2),"% (Tidal Fresh)")
```
...
```{r echo=FALSE}
cat("Change from",finalyear24,":", round(((finalvaluecurrent-finalvalue24)/finalvalue24*100),2),"% (High Salinity)")
```
